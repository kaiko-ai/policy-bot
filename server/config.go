...
func (c *Config) validateSecrets() error {
	if strings.TrimSpace(c.Github.App.WebhookSecret) == "" || c.Github.App.WebhookSecret == "app_secret" {
		return errors.New("github app webhook secret must be configured and must not use the example value")
	}
